...
exports.default = [{
	...
	content: 'Llegar a Nasca para ver estas enigm\xE1ticas l\xEDneas de Nazca sol\xEDa ser un esfuerzo grande y requer\xEDa mucho tiempo. Al menos que usted quisiera rentar su propio vuelo privado desde Lima, el acceso al p\xFAblico se limitaba en su mayor\xEDa en coche o autob\xFAs, que tomaba mucho tiempo (12-14 horas ida y vuelta) viaje desde Lima.\n\t\t\t\t"El sentimiento com\xFAn transmitida por los visitantes a las Lineas de Nasca era una frustraci\xF3n que tomaba mucho tiempo el trayecto de llegar al destino para un sobrevuelo de 40 minutos", explica Lucio - un gu\xEDa veterano de Per\xFA con m\xE1s de 20 a\xF1os experiencia.\n\t\t\t\tMientras que el enigma que es las L\xEDneas de Nasca es tan poderosa, para los viajeros que se reduce a la realidad de c\xF3mo quieren gastar su precioso tiempo de vacaciones - disfrutando de ese momento repleto de maravillas y actividades o hacinados en autobuses para largos per\xEDodos de tiempo.\n\t\t\t\tPor suerte, las enigm\xE1ticas L\xEDneas de Nasca est\xE1n ahora disponibles a los tiempos limitados. Lucio contin\xFAa, "realizando vuelos desde el nuevo aeropuerto de Pisco es mucho m\xE1s f\xE1cil El aeropuerto se encuentra a 15 minutos en coche de Paracas o un vuelo de 20 minutos de Lima. Ahorra todo un d\xEDa de viaje que se puede utilizar para disfrutar otros attraciones que Paracas ofrece"',
	id: '1',
	...
	content: '\u201CLo que parece ser una serpiente es en realidad la antigua deidad Q\'hoa. \xC9l era el siervo ... del dios del agua ... y fue utilizado en los rituales ... con respecto a la lluvia\u201D.',
	id: '2',
