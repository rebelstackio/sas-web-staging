...
exports.default = [{
    ...
    include: {
        standard: ['Todo el transporte terrestre y asistencia necesarios', 'Guía de habla inglesa', 'Entradas a todos los tours y excursiones', 'Tren, autobuses y entradas a Machu Picchu', 'Alojamiento en hotel seleccionado con baño privado (habitación doble)', 'Comidas según el itinerario', 'Vuelo nacional a menos que reserve directamente']
    },
    notinclude: ['Propinas para guías o el personal', 'Entrada a Huayna Picchu (sujeto a disponibilidad)'],
    img: {
    ...
    cruisesdates: [{ destination: "Marina ", title: "Oceania Cruises ", date: "Enero 8." }, { destination: "Volendam ", title: "Holland America ", date: "Enero 16, 17." }, { destination: "ISLAND PRINCESS ", title: "Princess Cruises ", date: "Enero 21, 22." }, { destination: "COSTA DELICIOZA ", title: "Costa Cruises ", date: "Enero 30." }, { destination: "Silver Shadow ", title: "Silver Sea ", date: "Febrero 5, 6." }, { destination: "Insignia ", title: "Oceania Cruises ", date: "Febrero 12." }],
    isDescriptive: true
}];
