...
exports.default = [{
    ...
    include: {
        standard: ['All necessary land transport and assistance.', 'English-speaking guide', 'Entrance fees for all tours and excursions.', 'Train, buses and entrance fees to Machu Picchu', 'Accommodation at selected hotel with private bathroom (double room basis).', 'Meals according to the itinerary.', 'Domestic flight unless you book directly.']
    },
    notinclude: ['Tips to guides or the staff', 'Entrance to Huayna Picchu (subject to availability)'],
    img: {
    ...
    media: ['https://i.imgur.com/WyO2Cm2.jpg', 'https://i.imgur.com/pHPibRX.jpg', 'https://i.imgur.com/23Q9HIG.jpg', 'https://i.imgur.com/pVMIhAX.jpg', 'https://i.imgur.com/2arNGAg.jpg', 'https://i.imgur.com/KA9ALkn.jpg', 'https://i.imgur.com/eIwymXn.jpg'],
    cruisesdates: [{ destination: "Marina ", title: "Oceania Cruises ", date: "January 8." }, { destination: "Volendam ", title: "Holland America ", date: "January 16, 17." }, { destination: "ISLAND PRINCESS ", title: "Princess Cruises ", date: "January 21, 22." }, { destination: "COSTA DELICIOZA ", title: "Costa Cruises ", date: "January 30." }, { destination: "Silver Shadow ", title: "Silver Sea ", date: "February 5, 6." }, { destination: "Insignia ", title: "Oceania Cruises ", date: "February 12." }, { destination: "MSC MAGNIFICA ", title: "MSC Cruises ", date: "February 15." }],
    isDescriptive: true
}];
