...
exports.default = {
		...
		tours: [{
				...
				additionalData: {
						include: ['Pick up from your hotel in Lima', 'Visit to the main square of Lima.', 'Visit to the Convent of San Francisco and its old catacombs.', 'Visit to the Olive of San Isidro, Miraflores and the shopping center of Larco Mar.', 'All entrance fees.', 'English speaking guide.'],
				...
				additionalData: {
						include: ['08:00 h. Pick up from your hotel in Lima. Private transportation.', '10:00 h. Arrival in Caral.', 'Guided tour at the ruins of Caral and Entrance fees.', 'Lunch at a local restaurant in Caral.', '14:00 h. Return to the city of Lima.', '16:00 h. Arrival in Lima. Drop off at your hotel at the end of the tour.'],
						notInclude: ['Extras & gratuities.'],
						duration: {
								subtitle: 'Full day',
								data: ['Departure: 8:00am', 'Times are estimated, except the departure time.']
						},
						recommendations: ['Bring water', 'Slippers or comfortable shoes', 'Caps, hat or umbrella.', 'Sunscreen', 'Sun glasses', 'Camera'],
						price: {
								currency: '$',
								ammount: 195,
								data: ['A minimum of 2 participants are required']
				...
				description: 'Ancient Peruvians were master metalworkers. The \u201Ccire perdue\u201D or lost wax process, known across the Orient and lost in the West until the Renaissance, was the most frequent technique used by master ancient Peruvian gold and silversmiths.\nOn our tour of Peru\u2019s Gold Museum, visitors will admire an awe-inspiring collection of gold artifacts from various pre-Colombian civilizations, some more than 3,000 years old.',
				additionalData: {
						include: ['Pick up from your hotel in Lima.', 'Guided visit to the Gold Museum and a visit to Friendship park.', 'All entrance fees.', 'English speaking guide.', 'Drop off at your hotel at the end of the tour.'],
						notInclude: ['Extras & gratuities.'],
						duration: {
								subtitle: '3 hours (approx.)',
								data: ['Departs daily at 9:00 am and 2:15 pm approximately']
						},
						price: {
								currency: '$',
								ammount: 50,
				...
				additionalData: {
						include: ['Pick up from your hotel in Lima and private transfer to the museums.', 'English speaking guide for both museums.', 'Entrance fee to the Larco Herrera Museum.', 'Entrance fee to the Archaeogical & Anthropological Museum.', 'Drop off at your hotel at the end of the tour.'],
						notInclude: ['Extras & gratuities.'],
						duration: {
								subtitle: '4 hours (approx.)',
								data: ['Departure: 9.15am and 2.15am', 'Times are estimated, except the departure time.', 'Archaeological Museum is closed every Monday.']
						},
						price: {
								currency: '$',
								ammount: 50,
				...
				additionalData: {
						include: ['Dinner', 'English speaking guide'],
						notInclude: ['Extras & gratuities.'],
						duration: {
								subtitle: '4 hours (approx.)',
								data: ['Departure: 6.30pm approx.']
						},
						price: {
								currency: '$',
								ammount: 55,
