export default {
		title:'Tours de Lima',
		subtitle:'Una vez llamada la Ciudad de los Reyes inundada de oro, Lima ha crecido hasta convertirse en una metrópolis moderna y cosmopolita.',
		description:'Una vasta y extensa ciudad y hogar de cerca de 9 millones de habitantes, Lima ofrece todas las comodidades modernas, cocina fantástica y una gran vida nocturna.',
...
Descubra Lima ancestral "Huaca Pucllana" - es el más importante centro ceremonial administrativo de la civilización Inca más desarrollada culturalmente de América del Sur entre 200 DC y 700 DC. Es la gran pirámide de adobe de barro construído durante este período, con sus siete plataformas asombrosas.
Lima Colonial, conservada en el centro histórico de Lima, es uno de los destinos turísticos más visitados en el Perú y América del Sur. Localizado principalmente en el centro de Lima, se ha conocido como la Ciudad de los Reyes durante milenios. Este patrimonio ha ganado apodo de la Unesco como Patrimonio de la Humanidad, es decir por su originalidad y la alta concentración de monumentos históricos construídos durante el dominio español.
...
Lima contemporánea goza de todo el mundo moderno que ofrecer y el recorrido se completa con una visita al moderno distrito de San Isidro, con una parada en el "huerto de olivo" y luego una visita a Miraflores y el fantástico centro comercial Larco Mar que se construye en los acantilados con vistas a la océano.`,
				...
				},
				{
						...
						description:`Sin duda este es el tours más rápido y menos agotador de visitar (en un solo día) con el confort que usted se merece.
Usted será recogido desde su hotel en una movilidad privada (con aire acondicionado, la movilidad depende de la cantidad de personas), la llegada será primero al muelle turístico de Paracas para el embarque a las Islas Ballestas, donde veremos gran población de aves marinas, y mamíferos marinos: lobos de mar, pingüinos de Humboldt, como también las espectaculares formaciones rocosas.
...
Al volver de las islas, usted tendrá tiempo para relajarse y caminar los alrededores del boulevard de Paracas donde podrá almorzar (opcional no incluída en el tour) por su cuenta antes de partir al aeropuerto, con su guía. Usted abordará una avioneta Cessna Gran Caravan de 12 personas con asientos amplios y grandes ventanas. Trabajamos con las mejores compañías aéreas que operan los últimos aviones y con personal experto para su seguridad. Su vuelo tendrá una duración de 95 minutos y en el camino a las líneas de Nasca, también verá los valles verdes de Ica y las vastas dunas montañosas de Huacachina. Al retorno del vuelo estará esperándole la movilidad para llevarlo de regreso a Lima a tiempo para la cena. (opcional no incluída en el tour)`,
						gallery: [
...
Caral fue descubierto en 1948, pero recibió poca atención hasta que un arqueólogo llamado Ruth Shady estudiase más a fondo la ciudad y los 5000 años de edad de las pirámides en el desierto peruano, con su elaborado complejo de templos, anfiteatro y las casas normales. El conjunto urbano se extiende sobre 150 acres (607.000 m²) y contiene varias plazas y edificios residenciales e indica que Caral era una próspera metrópolis en approximadamente el mismo tiempo que las grandes pirámides de Egipto se estaban construyendo.
La visita a Caral es un día completo, saliendo temprano desde Lima y regresando por la tarde. South Americans' Secrets organiza visitas guiadas solo con profesionales.
Y para los que tienen un interés especial en la arqueología, podemos ofrecer a los arqueólogos locales que pueden ofrecer información específica y académica sobre esta interesante ciudad antigua.`,
						additionalData:
						{
								...
								notInclude:[
								 ...
								 duration:{
										...
										data:[
											'Salida: 8:00am',
											'Los tiempos están estimados, excepto la hora de salida.',
										]
								},
								recommendations:[
									'Traer agua',
				...
				},
				{
						...
						description:`Los antiguos peruanos trabajaban los metales principales. El procedimiento "cire perdue" o perdido proceso de cera, conocido en Oriente y desaparecido en Occidente hasta el Renacimiento, fue el más empleado por estos magníficos orfebres peruanos.
...
Esculturas y joyas de inmenso valor en oro, plata y piedras preciosas, hechas a mano por los hijos del Dios Sol y monarcas del vasto Imperio Inca, están en exhibición para su asombro. Estos son los restos que atrajeron a tantos conquistadores españoles y aventureros europeos, en su búsqueda del oro Inkaiko.
El Museo de Oro del Perú también muestra una valiosa colección de armas antiguas y modernas que se consideran entre los mejores en el mundo. Las salas de esta sección muestran la Colección Mundial de armaduras, uniformes y diversos artefactos de guerra antiguos y armas de diferentes períodos de tiempo de todo el mundo, algunos que datan de fecha tan lejana como 1300 aC`,
						additionalData:
						{
								include:[
									'Recojo de su hotel en Lima.',
