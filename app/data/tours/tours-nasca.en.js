		...
		tours:[
			{
				...
				additionalData: {
					include: [
						'Pick up from your hotel in Nasca',
						'Transfer to the Nasca airport',
						'Assistance by a local guide',
						'Video film about the Nazca lines',
...
The International Festival of the Vicuña seeks to revive Andean culture and practices that utilize Pre-Inca techniques of management of these special animals.
Circling the extensive highland pastures with a human fence around the vicuñas through music, song and spirited movements help drive the vicuña toward the corral where they are classified and finally sheared for fibre. Afterwards they are released without endangering their existence.
...
Our guided tour starts at the time organized for your guide to pick you up from your hotel. the pampas galeras national reserve is located about 90 km from Nazca.`,
				additionalData: {
					include: [
						...
						'Transportation',
						'Local guide',
						'Entrance fees to museum of Pampas Galeras',
