		...
		tours:[
			{
				...
				additionalData: {
					include: [
						...
						'Visit to the Santa Calina Monastery',
						'Visit the colonial buildings surrounding Arequipa\'s main square',
						'Visit to the Cathedral of Arequipa',
						'Visit to the museum of Santuarios Andinos',
						'All entrance fees.',
					...
					duration: {
						...
						data:[
							'Departs daily at 9:00am and 2:00pm approximately'
						]
					},
					recommendations: [
					],
