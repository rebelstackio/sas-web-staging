export default {
    ...
    subtitle: ``,
    description: `
    Tenga todo listo para disfrutar de la mejor experiencia de su vida en el corazón de Machu Picchu y descubra un lugar mágico entre sus ruinas y mercados.
    ¡Vivamos la aventura!`,
...
itinerary: [
    ...
    },
    {
        ...
        contents: `En la mañana, visitará las ruinas y el pueblo de Ollantaytambo. Durante el imperio Inca, Ollantaytambo sirvió como un estado real y luego como refugio después de la conquista española de Cusco en 1537. Las ruinas tienen extensas terrazas y una arquitectura bien preservada. El pueblo sigue estando como lo estuvo durante el imperio Inca, permitiendo a los visitantes ver levemente la historia que aún existe dentro de sus bordes.
        
        Aborde el tren que y siga el río Urubamba cuyo curso sigue su camino hacia el Amazona y a la sagrada ciudad de Machu Picchu. Viaje por antiguos canales que aún llevan agua desde la cima de las montañas hacia los baños usados por sacerdotes Inca. Como visitante, usted es bienvenido a sumergir sus manos respetuosamente en el agua fría. Después de su tour guiado de Machu Picchu, usted regresará a la aldea de Aguas Calientes (ubicada en la base de Machu Picchu). Disfrute uno de los tantos excelentes restaurantes locales o termine su día en las aguas termales después de explorar uno de los sitios arqueológicos más mágicos en el mundo.
        `
    },
    {
        title: 'Día 5',
    ...
    },
    {
        ...
        contents: `En este día usted es libre para relajarse y explorar el área con un guía o por su cuenta. Puede visitar las iglesias y ruinas aledañas, como las enormes ruinas de Sacsayhuamán que vigilan Cusco desde arriba (estas ruinas exhiben bloques de construcción del tamaño de una pickup). También puede pasear a través de la concurrida Plaza de Armas en el corazón de Cusco, comprar pociones de amor en los mercados locales, o observar personas desde los cafés y restaurantes que decoran sus hermosas calles. Para aquellos llenos de energía, cabalgatas, ciclismo de montaña, o incluso rafting (Clase III-IV) pueden ser arreglados. La noche es suya para disfrutar de la emocionante y variada vida nocturna de Cusco donde la música folklórica en vivo y la excelente comida abunda! Disfrute de la última noche de sus vacaciones en Perú.
        `
    },
    {
        title: 'Day 7',
